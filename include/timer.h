...
#define TIM2_ovf_1ms() TCCR2B &= ~((1<<CS11) | (1<<CS10)); TCCR2B |= (1<<CS12);

/** @brief Set overflow 2ms, prescaler // 101 --> 128 */
#define TIM2_ovf_2ms() TCCR2B &= ~(1<<CS11); TCCR2B |= (1<<CS12) | (1<<CS10);

/** @brief Set overflow 4ms, prescaler // 110 --> 256 */
#define TIM2_ovf_4ms() TCCR2B &= ~(1<<CS10); TCCR2B |= (1<<CS12) | (1<<CS11);
